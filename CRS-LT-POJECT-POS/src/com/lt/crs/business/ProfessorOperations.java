	...
	public void professorReg() {
		...
		if(b==true) {
			//ProfessorNotRegisteredException pe= new ProfessorNotRegisteredException();
			 System.out.println("************************************************************");
			 System.out.println("Professor Registration Pending for Admin Approval");
			// log.error("Pending for Admin Approval");
			//System.out.println("User Registration Failed");
			System.out.println("************************************************************");
		 }else {
			 System.out.println("************************************************************");
			 System.out.println("The course ID or Course Name Does not match. Please select proper details.");
