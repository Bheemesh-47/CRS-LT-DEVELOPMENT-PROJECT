 ...
 * @author Group-2
 * 
 * description : includes all the admin functionalities
 *         which then connects with admin producer service
 */
@RestController
public class AdminControllerClient {
	/**
	 * Injecting {@link DiscoveryClient} 
	 * throw @autowired annotation
	 */
	...
	@RequestMapping(method = RequestMethod.DELETE, value = "/deleteProfessor/{professorId}")
